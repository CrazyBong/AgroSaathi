      ...
      <div className="max-w-md w-full space-y-8 text-center relative z-10">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <Link 
              href="/farmer"
              className="block cursor-pointer hover:shadow-2xl transition-all duration-300 border-2 border-green-200 hover:border-green-400 transform hover:-translate-y-1 bg-gradient-to-br from-white to-green-50 group rounded-xl overflow-hidden"
            >
              <div className="p-6">
                <div className="flex items-center space-x-6">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-green-600 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Link 
              href="/trader"
              className="block cursor-pointer hover:shadow-2xl transition-all duration-300 border-2 border-blue-200 hover:border-blue-400 transform hover:-translate-y-1 bg-gradient-to-br from-white to-blue-50 group rounded-xl overflow-hidden"
            >
              <div className="p-6">
                <div className="flex items-center space-x-6">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600 group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                  </svg>
                </div>
              </div>
